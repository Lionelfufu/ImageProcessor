...
/**
 * create a new intensity grey scaled image by modifying the images that already exists in the
 * program. Then load this new image to the program and give it a new name.
 */
public class GreyScaleIntensity extends ChangeImageAndLoad {

  /**
   * Constructs a GreyScaleIntensity command.
   *
   * @param imageName     the name of the image to be used to modify
   * @param destImageName the name of the new image
   */
  public GreyScaleIntensity(String imageName, String destImageName) {
  ...
  public void process(ImagesModel images) throws IllegalArgumentException {
    ...
    newImage = original.greyScale("intensity");
